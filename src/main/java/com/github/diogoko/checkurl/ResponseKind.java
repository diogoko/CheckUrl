...
/**
 * The kind of response received after a request to a URL.
 */
public enum ResponseKind {
	/**
	 * A successful response.
	 *
	 * <p>This corresponds to HTTP responses with codes between 100 and 300.</p>
	 */
	Success,
	/**
	 * An unsuccessful response.
	 *
	 * <p>This corresponds to HTTP responses with codes equal or greater than 400.</p>
	 */
	Error,
	/**
	 * A non-existent response (becaused it timed out).
	 */
	Timeout
